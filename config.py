...
class ConfigManager:
    ...
    fallback_src = Parameter(["presets", "fallback", "source"])
    fallback_dst = Parameter(["presets", "fallback", "destination"])
    fallback_lang = Parameter(["presets", "fallback", "language"])
    fallback_voice = Parameter(["presets", "fallback", "voice"])
